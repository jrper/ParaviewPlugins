#include "TemporalXMLPolyDataReader.h"
...
int TemporalXMLPolyDataReader::RequestInformation(
...
void TemporalXMLPolyDataReader::PrintSelf(ostream& os, vtkIndent indent)
{
